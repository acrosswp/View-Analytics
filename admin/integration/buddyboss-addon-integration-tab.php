 ...
 * @subpackage View_Analytics/admin/partials
 */
 ...
 */
class View_Analytics_Admin_Integration_Tab extends BP_Admin_Integration_tab {
	...
	public function is_addon_field_enabled( $default = 1 ) {
		return (bool) get_option( 'view-analytics_field', $default );
	}

	public function settings_callback_field() {
		?>
        <input name="view-analytics_field"
               id="view-analytics_field"
               type="checkbox"
               value="1"
			<?php checked( $this->is_addon_field_enabled() ); ?>
        />
        <label for="view-analytics_field">
			<?php _e( 'Enable this option', 'view-analytics' ); ?>
        </label>
		<?php
	}
	...
	public function get_settings_fields() {
		...
		$fields['view-analytics_settings_section'] = array(

			'view-analytics_field' => array(
				'title'             => __( 'Add-on Field', 'view-analytics' ),
    ...
    public function get_settings_sections() {
        return array(
			'view-analytics_settings_section' => array(
				'page'  => 'view-analytics',
				'title' => __( 'Add-on Settings', 'view-analytics' ),
			),
		);
    }
