...
abstract class View_Analytics_Plugins_Dependency {

    function __construct() {

        add_filter( 'view-analytics-load', array( $this, 'boilerplate_load' ) );
    ...
    public function get_plugin_name() {
        ...
        $plugin_data = get_plugin_data( VIEW_ANALYTICS_FILES );
